...
public class verficationHR {
    ...
    static public String post(String userId,String stime,String etime ) {
        ...
        String uri = "https://elb-test.zenhr.cn/PUB/IF/WS.FWK?HANDLERNAME=ifds&METHOD=IF_RTN_DS_QUERY&OP_CODE=1910180001&JWT_OBJ=" + token + "&REQUEST_ID="+aREQUESTID+"&LANGUAGE=zh-cn";
        ...
        try {
            ...
            if(codeV.equals("1")||codeV1.equals("1")) {
                ...
                String pendDatetime = rootNode.path("DATA1").get(0).path("p_end_datetime").asText();
    ...
    public static   String post1(String userId, String stime, String etime, String keyed, String actionCode ) {
        ...
        try {
            ...
            if (codeV.equals("1") || codeV1.equals("1")) {
                ...
                String uri = "https://elb-test.zenhr.cn/PUB/IF/WS.FWK?HANDLERNAME=ifds&METHOD=IF_RTN_DS_QUERY&OP_CODE=1910180001&JWT_OBJ=" + token + "&REQUEST_ID=40f79234-0f1b-11ee-ae80-0c42a1b8824e&LANGUAGE=zh-cn";
                String bod = "{\n" +
                        "    \"^hrwf_apptype\":\"1\",\n" +
