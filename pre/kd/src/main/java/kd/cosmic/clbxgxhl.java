 ...
 */
//kd.cosmic.clbxgxhl
public class clbxgxhl extends AbstractFormPlugin{
            ...
            if (fycdgs != null) {
                ...
                if(fycdgsnumber.equals("LE0002")){
                    ...
                    for (DynamicObject entry : entryEntity) {
                        ...
                        try {
                            if(this.getModel().getValue("trip2enddate",i) != null){
                                Date date = originalFormat.parse(this.getModel().getValue("trip2enddate",i).toString());
