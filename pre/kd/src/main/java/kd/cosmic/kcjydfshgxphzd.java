...
public class kcjydfshgxphzd extends AbstractOperationServicePlugIn {
    public void afterExecuteOperationTransaction(AfterOperationArgs e) {
        try {
            for (DynamicObject dy : e.getDataEntities()) {
                Long billId = Long.valueOf(String.valueOf(dy.getPkValue()));
                DynamicObject aBILL = BusinessDataServiceHelper.loadSingle(billId, "qcnp_invbalinspec", "lotnumber,newarrdate");
                ...
                for (DynamicObject dynamicObject : dynamicObjectCollection) {
                    ...
                    DynamicObject[] phzdBill = BusinessDataServiceHelper.load("bd_lot", "ezob_yccs", new QFilter[] { q2 });
